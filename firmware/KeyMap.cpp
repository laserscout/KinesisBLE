...
const Keymap::Key Keymap::layout[][(int)Matrix::Dim::Row][(int)Matrix::Dim::Col] = {
  [(int)Layer::Base] = {
    ...
    { Key::Tab,       Key::SQuote,     Key::Comma,   Key::Period,  Key::P,     Key::Y,      Key::F,     Key::G,     Key::C,     Key::R,       Key::L,       Key::Slash,   Key::F3,    Key::F4,    Key::F5   },
    { Key::Capslock,  Key::A,          Key::O,       Key::E,       Key::U,     Key::I,      Key::D,     Key::H,     Key::T,     Key::N,       Key::S,       Key::BSlash,  Key::F6,    Key::F7,    Key::F8   },
    { Key::LShift,    Key::Semicolon,  Key::Q,       Key::J,       Key::K,     Key::X,      Key::B,     Key::M,     Key::W,     Key::V,       Key::Z,       Key::RShift,  Key::F9,    Key::F10,   Key::F11  },
